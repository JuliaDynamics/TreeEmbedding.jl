...
@testset "TreeEmbedding prediction of Lorenz" begin
    ...
    optmodel = TreeEmbedding.MCDTSOptimGoal(TreeEmbedding.PredictionError(PredType, 0, 1,[error_weight_insample; error_weight_oosample]), TreeEmbedding.RangeFunction())
    ...
    PredType = TreeEmbedding.MCDTSpredictionType(PredLoss, PredMeth)
    optmodel = TreeEmbedding.MCDTSOptimGoal(TreeEmbedding.PredictionError(PredType, 0, 1), TreeEmbedding.ContinuityFunction())
    ...
    PredLoss = TreeEmbedding.PredictionLoss(1)
    PredType = TreeEmbedding.MCDTSpredictionType(PredLoss, PredMeth)
    optmodel = TreeEmbedding.MCDTSOptimGoal(TreeEmbedding.PredictionError(PredType,0,samplesize,[error_weight_insample; error_weight_oosample]), TreeEmbedding.ContinuityFunction())
    ...
    PredLoss = TreeEmbedding.PredictionLoss(2)
    PredType = TreeEmbedding.MCDTSpredictionType(PredLoss, PredMeth)
    optmodel = TreeEmbedding.MCDTSOptimGoal(TreeEmbedding.PredictionError(PredType,0,1,[error_weight_insample; error_weight_oosample]), TreeEmbedding.ContinuityFunction())
